  ...
  <!--fin del div contenedor de datos y de la foto-->
   ...
   <form class="formTutorSolP" action="">
    <div class="tituloDatosTutor">
        <p style="right: 500px;width: 3000px">ALUMNOS CON REPORTES PENDIENTES DE AUTORIZAR</p>
              ...
              @foreach($reportes as $reporte)
                @foreach($solicitud as $sol)
                  <tr>
                      ...
                      <th>{{$reporte->numReporte}}</th>
                      <th><a href="/autorizaReportesEncargado/{{$encargado->rpe}}/{{$reporte->idReporte}}">Ver</a></th>
                      <th><a href="/Elimina/{{$reporte->idRegistroPracticas}}">Eliminar</a></th>
                  <tr></tr>
                  </tr>
                @endforeach
              @endforeach  
