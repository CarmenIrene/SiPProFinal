    ...
    <div class="menu" style="height:55px">
        ...
        @if(isset($reportes)&&isset($solicitud))
          @if(($reportes->statusReporte == "Aprobado") && ($reportes->numReporte == 'REPORTE FINAL'))
           <li class="menuitem">
            <a href="/EvaluacionAlumnoEmpresa/{{$alumno->claveUnica}}">Evaluación</a>
          </li>
          @endif
        @endif
        ...
        <tbody>
          <tr class="trClaveUnica">
             ...
             <td class="tdSolicitud">Comentarios <br> Tutor Académico: </td>
              ...
              <tr>
                  <th>{{$reportes->numReporte}}</th>
                  <th>{{$alAutorizacionReporte->fechaAutorizacionTutorAcademico}}</th><!--Aqui va el nombre del alumno-->
                  <th>{{$alAutorizacionReporte->comentariosTutorAcademico}}</th>
                  <tr></tr>
              </tr>
        </tbody>
      </table>
          ...
          <tbody>
            <tr class="trClaveUnica">
               ...
               <td class="tdSolicitud">Comentarios Encargado: </td>
                ...
                <tr>
                    <th>{{$reportes->numReporte}}</th>
                    <th>{{$alAutorizacionReporte->fechaAutorizacionEncargado}}</th><!--Aqui va el nombre del alumno-->
                    <th>{{$alAutorizacionReporte->comentariosEncargado}}</th>
                    <tr></tr>
                </tr>
          </tbody>
        </table>      
