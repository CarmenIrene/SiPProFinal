...
class AutorizacionesReportesController extends Controller
{
    ...
    //    dd($reportes);
        ...
        //dd($rpe);
    	return view('autorizaReportesTutorAcademico')->with('tutor',$tutor)->with('registroreporte',$reportes)->with('alumno',$alumno)->with('fecha',$fecha)->with('emp',$emp)->with('ase',$asesor)->with('fechaAut',$fechaAut)->with('archivo',$archivoReporte);        
    } 
